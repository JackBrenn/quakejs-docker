...
- 🔒 Personal fork of the Quake3JS Core for Updated NPM dependencies, **to remove CRITICAL and HIGH vulnerabilities** ([quakejs](https://github.com/JackBrenn/quakejs))
